 ...
 */
public class saveDeviceId extends AsyncTask<Void, Void, Void> {

    private static final String TAG = "SaveDeviceID";
    private Context mContext;

    public saveDeviceId(Context context) {
        mContext = context;
    }
    ...
    protected Void doInBackground(Void... params) {
        try {
            String request = "http://192.168.1.10/appdata/census/savedeviceid.php";
            ...
            jsonParam.put("DeviceNo", LoginActivity.DeviceNo);
